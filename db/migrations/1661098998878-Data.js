module.exports = class Data1661098998878 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "liquidity_position" ("id" character varying NOT NULL, "user" text NOT NULL, "liquidity_token_balance" numeric(38,20) NOT NULL, "pair_id" character varying, CONSTRAINT "PK_db00d963c96b3914d26abe3c3d2" PRIMARY KEY ("id"))`)
